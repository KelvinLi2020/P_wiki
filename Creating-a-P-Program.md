Once you have built the P compiler following these steps, you can now use it in your new sample app by integrating it into your *.vcxproj file.  Follow these steps:
